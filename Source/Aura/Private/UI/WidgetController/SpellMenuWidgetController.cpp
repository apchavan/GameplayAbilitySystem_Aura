...
void USpellMenuWidgetController::SpellGlobeSelected(const FGameplayTag& AbilityTag)
{
	...
	{
		/**
		 * We either have an AbilityTag for an ability that we don't have yet, or an AbilityTag for an ability that
		 * does not exist like 'Abilities.None'.
		 */
...
void USpellMenuWidgetController::ShouldEnableButtons(
	const FGameplayTag& AbilityStatus, const int32 SpellPoints,
