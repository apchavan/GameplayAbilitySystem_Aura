...
AAuraCharacter::AAuraCharacter()
{
	...
	LevelUpNiagaraComponent->SetAutoActivate(false); // Or we can write, `LevelUpNiagaraComponent->bAutoActivate = false;`
...
void AAuraCharacter::MulticastLevelUpParticles_Implementation() const
{
	if (IsValid(LevelUpNiagaraComponent))
	{
		...
		// Rotator for the rotation from the Niagara System to the camera and we get that from a vector that goes
		// from the Niagara System to the camera.
		// That vector would be the difference between the camera's location and Niagara System Location.
...
void AAuraCharacter::ShowMagicCircle_Implementation(UMaterialInterface* DecalMaterial, const float InRadiusSize)
{
	...
	{
		AuraPlayerController->ShowMagicCircle(DecalMaterial, InRadiusSize);
